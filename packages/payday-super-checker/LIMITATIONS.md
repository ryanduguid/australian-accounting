...
and with pay-period start and end columns on the super file. Where a re-export
is not available, reconcile the affected employees by hand before relying on
their verdicts.
