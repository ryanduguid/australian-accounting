...
def build() -> None:
    ...
    summary = [
        ...
        ("Total notional earnings",
         '=IF(SUM(tblLines[Past_gic_table])>0,"Not assessed",ROUND(SUM(tblLines[NEC_r]),2))'),
        ("Experimental SG charge estimate, low",
         '=IF(SUM(tblLines[Past_gic_table])>0,"Not assessed",ROUND(SUM(tblLines[SGC_low]),2))'),
        ("Experimental SG charge estimate, high",
         '=IF(SUM(tblLines[Past_gic_table])>0,"Not assessed",ROUND(SUM(tblLines[SGC_high]),2))'),
