...
- The s 205-70 FDT offset reduction no longer switches off when zero franking credits arose in the year: with zero credits, any deficit exceeds 10% of them.
...
- The BREPI 80% test compares exactly instead of on a 2dp-rounded ratio; the franking percentage caps at 100; the benchmark comparison works in dollars at each event's own rate; the stated franking credit rounds down so it never exceeds the s 202-60 maximum; negative and out-of-range inputs are refused.
