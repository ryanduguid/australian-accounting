...
@pytest.mark.parametrize("function,arguments,expected", [
    ...
    pytest.param(c.fbt, (D("8500"), D("0"), 2026, True),
                 {"type_one_grossed_up": "17681.70", "type_two_grossed_up": "0.00",
                  "fbt_estimate": "8310.40", "return_item_14a": "17682.00",
                  "return_item_14b": "0.00", "return_item_15": "17682.00",
                  "return_item_16": "8310.54"}, id="fbt-library-3-020-established-value-only"),
