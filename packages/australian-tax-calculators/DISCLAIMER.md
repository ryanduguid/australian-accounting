...
Australian tax calculators runs 9 bounded worksheets on facts the caller has
already established: ordinary GST, resident basic income tax, CGT losses and
the discount, ordinary employer FBT, first-year depreciation, quarterly super
guarantee, PAYG withholding, super contribution caps and account-based pension
minimums. It is not tax, legal, accounting, financial, investment,
