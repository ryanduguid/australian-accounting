...
Published MCP v0.2.4 pins `payday-super-checker==0.1.6`, which includes the pack
builder. Run `uvx aus-accounting-mcp==0.2.4` for that version. An installation with
